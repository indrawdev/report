<?php
	$d = $detail->row();
	$filename = 'tabel-fpd-surveyor-'. strtolower($nama_cabang->fs_nama_cabang . '-'. $d->fs_ptgsvy) .'.xls';
...
<h1 align="center">
	TABEL FPD SURVEYOR - <?php echo $d->fs_ptgsvy; ?>
	<br>PENCAIRAN PERIODE (<?php echo strtoupper($tanggal_mulai) . ' s/d ' . strtoupper($tanggal_selesai); ?>)
</h1>
